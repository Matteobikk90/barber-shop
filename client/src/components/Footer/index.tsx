...
const Footer = () => {
    return (
        <footer tw="bg-green text-cream">
            <div tw="grid grid-cols-4 lg:grid-cols-2 sm:grid-cols-1 gap-[3rem] p-[4rem] md:p-[3rem 2rem] sm:p-[2.5rem 1.5rem]">
                <div>
                    <img
                        width={180}
                ...
                <div tw="flex flex-col gap-[0.4rem]">
                    <p tw="text-xs font-bold uppercase tracking-widest opacity-50 mb-[0.5rem]">Dove siamo</p>
                    <p>Via Manzoni 21/A</p>
                    <p>Rivoli (TO), 10098</p>
                    <a tw="hover:opacity-70 transition-opacity" href="mailto:blendon.barbershop@gmail.com">
                ...
                <div tw="flex flex-col gap-[0.4rem]">
                    <p tw="text-xs font-bold uppercase tracking-widest opacity-50 mb-[0.5rem]">Orari</p>
                ...
                <div tw="flex flex-col gap-[0.75rem]">
                    <p tw="text-xs font-bold uppercase tracking-widest opacity-50">Seguici su</p>
            ...
            <div tw="border-t border-[rgba(255,255,255,0.12)] px-[4rem] py-[1.25rem] md:px-[2rem] sm:px-[1.5rem] text-xs opacity-50 text-center">
                © {new Date().getFullYear()} Blendon Barbershop. Tutti i diritti riservati.
            </div>
        </footer>
    );
};
