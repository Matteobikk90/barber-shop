...
const Step3 = ({
  ...
  <BookingFormContainer title="Inserisci i tuoi dati, conferma le policy e prenota">
    <div tw="flex justify-center">
      <div tw="flex flex-col gap-[1.5rem] text-xxl">
        <div tw="flex gap-[2rem] sm:flex-wrap">
          <div tw="flex flex-col items-start gap-[0.5rem] w-full">
            ...
            <input
              ...
              required
              type="text"
              onChange={(e) => handleBookingInfo!({ name: e.target.value })}
              name="name"
            />
          </div>
          <div tw="flex flex-col items-start gap-[0.5rem] w-full">
        ...
        <div tw="flex items-center gap-[0.5rem]">
          ...
          />
          *
          <label tw="text-xl text-black" htmlFor="confirmation">
            Ho letto e accetto i{" "}
            <NavLink tw="text-cream font-bold" to="/terms-and-conditions">
              Termini e Condizioni
            </NavLink>{" "}
            e{" "}
            <NavLink tw="text-cream font-bold" to="/privacy-and-policy">
              l'Informativa sulla Privacy
            </NavLink>
            .
          </label>
        </div>
        <p tw="text-left text-xl">* Tutti i campi sono obbligatori</p>
        <div>
          <input
            tw="h-0 opacity-0"
            type="text"
